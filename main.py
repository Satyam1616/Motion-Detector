...
TELEGRAM_BOT_TOKEN = '6751382069:AAHUcR7yUJ2rZ2uT-JbPoYOvDDbMO5XVVDk'
TELEGRAM_CHAT_ID = 1779961620
...
while True:
    ...
    if motion_detected:
        ...
        send_telegram_message("Motion detected!.")  # Send Telegram notification
